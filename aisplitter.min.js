 ...
 */
!function(t){"use strict";function r(){}function e(t,r){this.width=0,this.height=0,this.numPlays=0,this.frames=[],this.playTime=0,this._onload=[],this.loaded=!1,this._urlToFrames(t,r)}function n(t){for(var r=0,e=0;4>e;++e)r+=t.charCodeAt(e)<<8*(3-e);return r}function a(t){for(var r=0,e=0;2>e;++e)r+=t.charCodeAt(e)<<8*(1-e);return r}function s(t,r){var e="";return e+=o(r.length),e+=t,e+=r,e+=o(h(t+r))}function o(t){return String.fromCharCode(t>>24&255,t>>16&255,t>>8&255,255&t)}function i(){this.parts=[]}function h(t){for(var r=-1,e=0,n=t.length;n>e;++e)r=r>>>8^f[255&(r^t.charCodeAt(e))];return-1^r}var d=navigator.userAgent.match(/msie [9.]/i);d&&document.addEventListener("DOMContentLoaded",function(){var t=document.createElement("script");t.setAttribute("type","text/vbscript"),t.text="Function IEBinaryToBinStr(Binary)\r\n   IEBinaryToBinStr = CStr(Binary)\r\nEnd Function\r\n",document.body.appendChild(t)}),r.prototype.read=function(t,r){var n=new e(t,r);return n},t.AISplitter=r,e.prototype.on=function(t,r){if("load"!==t)throw new Error("Don't exist '"+t+"' event");this._onload.push(r)},e.prototype.off=function(t,r){if("load"!==t)throw new Error("Don't exist '"+t+"' event");if("function"==typeof r)for(var e=0,n=this._onload.length;n>e;++e)this._onload[e]===r&&this._onload.splice(e,1);else"undefined"==typeof r&&(this._onload=[])},e.prototype._urlToFrames=function(t,r){var e=this,n=new XMLHttpRequest,a="responseType"in n,s="overrideMimeType"in n;n.open("GET",t,!0),a?n.responseType="blob":s&&n.overrideMimeType("text/plain; charset=x-user-defined"),n.onreadystatechange=function(){if(4==this.readyState&&200==this.status)if(a){var t=new FileReader;"readAsBinaryString"in t?(t.onload=function(){e._switchType(this.result,r)},t.readAsBinaryString(this.response)):(t.onload=function(){for(var t="",n=new Uint8Array(this.result),a=n.byteLength,s=0;a>s;++s)t+=String.fromCharCode(n[s]);e._switchType(t,r)},t.readAsArrayBuffer(this.response))}else{var n="";if(d)for(var s=IEBinaryToBinStr(this.responseBody),o=0,i=s.length;i>o;++o){var h=s.charCodeAt(o);n+=String.fromCharCode(255&h,h>>8&255)}else for(var p=this.responseText,f=0,u=p.length;u>f;++f)n+=String.fromCharCode(255&p.charCodeAt(f));e._switchType(n,r)}else if(4==this.readyState)throw new Error("Can't read file")},n.send()},e.prototype._switchType=function(t,r){if("image/png"===r)this._parseAPNG(t);else{if("image/jpeg"!==r)throw new Error("Don't support type");this._parseMJPEG(t)}},e.prototype._parseAPNG=function(t){if(t.substr(0,8)!==p)throw new TypeError("This file is not PNG");var r,e,h,d,f="",u="",l=!1,c=8,g=null;do{switch(e=n(t.substr(c,4)),h=t.substr(c+4,4)){case"IHDR":d=t.substr(c+8,e),r=d,this.width=n(d.substr(0,4)),this.height=n(d.substr(4,4));break;case"acTL":l=!0,this.numPlays=n(t.substr(c+12,4));break;case"fcTL":g&&this.frames.push(g),d=t.substr(c+8,e),g={},g.width=n(d.substr(4,4)),g.height=n(d.substr(8,4)),g.left=n(d.substr(12,4)),g.top=n(d.substr(16,4));var y=a(d.substr(20,2)),m=a(d.substr(22,2));0===m&&(m=100),g.delay=1e3*y/m,g.delay<=10&&(g.delay=100),this.playTime+=g.delay,g.disposeOp=d.charCodeAt(24),g.blendOp=d.charCodeAt(25),g.dataParts=[];break;case"fdAT":g&&g.dataParts.push(t.substr(c+12,e-4));break;case"IDAT":g&&g.dataParts.push(t.substr(c+8,e));break;case"IEND":u=t.substr(c,e+12);break;default:f+=t.substr(c,e+12)}c+=e+12}while("IEND"!==h&&c<t.length);if(g&&this.frames.push(g),g=null,!l)throw new TypeError("Non-animated PNG");for(var w=0,v=this,b=0,C=this.frames.length;C>b;++b){var T=new Image;g=this.frames[b],g.img=T,T.onload=function(){++w,w===v.frames.length&&v._loadend()},T.onerror=function(){throw new Error("Image creation error")};var A=new i;A.append(p),r=o(g.width)+o(g.height)+r.substr(8),A.append(s("IHDR",r)),A.append(f);for(var E=0;E<g.dataParts.length;++E)A.append(s("IDAT",g.dataParts[E]));A.append(u),T.src=A.getUrl("image/png"),delete g.dataParts}},e.prototype._parseMJPEG=function(t){for(var r=String.fromCharCode(255),e=r+String.fromCharCode(216),n=r+String.fromCharCode(217),s=0,o=1,h=0;4>h;++h)s+=t.charCodeAt(32+h)*o,o*=256;s/=1e3;for(var d,p=t.match(new RegExp(e+"[\\s\\S]+?"+n,"g")),h=0,f=p.length;f>h;++h){for(var u=[],l=192;207>=l;)196!==l&&200!==l&&204!==l&&u.push(String.fromCharCode(l)),++l;d={};var c=p[h].search(new RegExp(r+"["+u.join("")+"]"));d.height=a(p[h].substr(c+5,2)),d.width=a(p[h].substr(c+7,2)),d.top=d.left=0,d.delay=s,this.playTime+=s,this.frames.push(d)}if(p.length!==this.frames.length)throw new TypeError("Shotage JPG SOF data");this.height=this.frames[0].height,this.width=this.frames[0].width;for(var g=0,y=this,h=0,f=this.frames.length;f>h;++h){var m=new Image;this.frames[h].img=m,m.onload=function(){++g,g===y.frames.length&&y._loadend()},m.onerror=function(){throw new Error("Image creation error")};var w=new i;w.append(p[h]),m.src=w.getUrl("image/jpeg")}},e.prototype._loadend=function(){this.loaded=!0;for(var t=0,r=this._onload.length;r>t;++t)this._onload[t].call(this)};var p=String.fromCharCode(137,80,78,71,13,10,26,10);i.prototype.append=function(t){this.parts.push(t)},i.prototype.getUrl=function(r){return t.btoa?"data:"+r+";base64,"+btoa(this.parts.join("")):"data:"+r+","+escape(this.parts.join(""))};for(var f=new Array(256),u=0;256>u;++u){for(var l=u,c=0;8>c;++c)l=1&l?3988292384^l>>>1:l>>>1;f[u]=l}}(this);